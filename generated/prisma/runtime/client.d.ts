 ...
 * Defines Exception.
 *
 * string or an object with one of (messages or name or code) and optional stack
 */
...
declare enum SpanKind {
    ...
    CLIENT = 2,
    /**
     * Indicates that the span describes producer sending a messages to a
     * broker. Unlike client and server, there is no direct critical path latency
     * relationship between producer and consumer spans.
     */
    PRODUCER = 3,
    /**
     * Indicates that the span describes consumer receiving a messages from a
     * broker. Unlike client and server, there is no direct critical path latency
     * relationship between producer and consumer spans.
     */
    CONSUMER = 4,
...
declare interface SpanStatus {
    /** The status code of this messages. */
    code: SpanStatusCode;
    /** A developer-facing error messages. */
    message?: string;
}
