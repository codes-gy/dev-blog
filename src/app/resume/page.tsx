                    ...
                    <section className="relative border-l-2 border-slate-200 pl-5 md:pl-7 dark:border-slate-800">
                        ...
                        <ProjectSection
                            ...
                            metrics={[
                                {
                                    label: '연령별 맞춤 상품',
                                    value: '최신순 상품 노출 방식을 연령별 데이터 기반 맞춤 추천 API 개발로 고도화하여 추천 상품 클릭 전환율을 기존 대비 25% 향상',
                                },
                                {
                                    label: '유아 도서 등록',
                                ...
                                {
                                    label: '전체 API 개발 공수',
                                    value: '공통 로직 부재로 인한 중복 코드 양산 구조를 모듈화 및 리팩토링으로 개선하여 전체 API 개발 공수를 기존 대비 15일 단축',
                                },
                                {
                                    label: '콘텐츠 반영 속도',
                            ...
                            troubleshooting={{
                                ...
                                task: '오배포 시 버튼 하나로 이전 버전으로 롤백하는 시스템이 필요',
                    ...
                    <section className="relative border-l-2 border-slate-200 pl-5 md:pl-7 dark:border-slate-800">
                        ...
                        <ProjectSection
                            ...
                            metrics={[
                                ...
                                {
                                    label: '제출용 문서 생성',
                                    value: '문서 렌더링 시 발생하는 다중 JOIN 병목을 쿼리 최적화 및 데이터 사전 계산 기법으로 해결하여 문서 생성 시간을 40% 감소',
                                },
                                {
                                    label: '단말기 인증 및 보안',
