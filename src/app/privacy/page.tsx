...
export default function PrivacyPolicyPage() {
    return (
        <div className="min-h-screen bg-slate-50 px-4 py-8 md:px-6 md:py-16 dark:bg-slate-950">
            <article className="mx-auto max-w-3xl rounded-xl border border-slate-200 bg-white px-4 py-5 shadow-sm md:rounded-2xl md:p-12 dark:border-slate-800 dark:bg-slate-900">
                {/* 🏷️ 상단 헤더 영역 */}
                <header className="border-b border-slate-100 pb-4 dark:border-slate-800">
                    {/* PC 제목 크기 확대 (md:text-2xl ➔ md:text-3xl) */}
                    <h1 className="text-base font-bold tracking-tight text-slate-900 md:text-3xl dark:text-slate-50">
                        개인정보처리방침
                    </h1>
                    {/* PC 시행일자 크기 확대 (md:text-sm ➔ md:text-base) */}
                ...
                <div className="mt-5 flex flex-col gap-5 text-[13px] leading-relaxed text-slate-600 md:mt-10 md:gap-8 md:text-base dark:text-slate-300">
                    {/* 섹션 1 */}
                    <section>
                        {/* PC 조항 제목 확대 (md:text-base ➔ md:text-lg) */}
                        ...
                        <p className="text-slate-500 dark:text-slate-400">
                            본 블로그는 별도의 회원가입 없이 컨텐츠를 자유롭게 이용할 수 있습니다. 단, 사용자가
                            &apos;문의하기&apos; 시스템을 이용하는 경우 회신을 위한 이메일 주소를 수집합니다. 또한,
                            인터넷 서비스 이용과정에서 **방문자의 IP 주소, 쿠키, 서비스 이용 기록, 방문 기록**이
                    ...
                    <section>
                        ...
                        <p className="text-slate-500 dark:text-slate-400">
                            문의하기를 통해 접수된 이메일 및 데이터는 안내 답변 및 사용자 피드백 처리가 완료된 후 지체
                            없이 영구 파기됩니다. 관계 법령에 의해 특별히 보존할 필요가 있는 경우가 아니라면 어떠한 수집
                    ...
                    <section>
                        ...
                        <p className="text-slate-500 dark:text-slate-400">
                            ...
                            요청할 수 있습니다. 상단 메뉴의 &apos;문의하기&apos; 창구를 통해 연락 주시면 관리자는 지체
                            없이 즉각 파기 조치하겠습니다.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        {/* PC에서 안내 박스 내부 폰트 확대 (md:text-sm) */}
                        <div className="mt-2 rounded-lg border border-slate-100 bg-slate-50/50 p-3 text-[11px] md:mt-3 md:p-4 md:text-sm dark:border-slate-800 dark:bg-slate-950/50">
                            ...
                            <p className="mt-1">
                                • <strong>문의처:</strong> 사이트 내 상단 &apos;문의하기&apos; 페이지 양식 이용
                            </p>
                        </div>
                    </section>
                </div>
